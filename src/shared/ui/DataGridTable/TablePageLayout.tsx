...
import { DataGridTable } from '@/shared/ui/DataGridTable/index.ts';
      ...
      {isEmpty && emptyState ? (
        <div className="card p-12">
          <div className="text-center">
            {emptyState.icon && <emptyState.icon className="mx-auto h-12 w-12 text-gray-400" />}
            <h3 className="mt-2 text-sm font-medium text-gray-900">{emptyState.message}</h3>
