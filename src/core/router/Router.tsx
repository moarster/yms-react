...
const dynamicRoutePatterns = [
    { pattern: /^\/catalog\//, loader: () => import('@/features/catalogs/CatalogItemsPage.tsx') },
    { pattern: /^\/list\//, loader: () => import('@/features/catalogs/CatalogItemsPage.tsx') },
    { pattern: /^\/shipment-rfps\/[^/]+$/, loader: () => import('@/features/documents/pages/ShipmentRfpDetailPage.tsx') },
]
...
const prefetchRoute = (path: string) => {
    ...
    for (const { pattern, loader } of dynamicRoutePatterns) {
    ...
    useEffect(() => {
        ...
        switch (location.pathname) {
            ...
            default:
                ...
                } else if (location.pathname.startsWith('/catalog/') || location.pathname.startsWith('/list/')) {
...
export const ResourceHints: React.FC = () => {
    useEffect(() => {
        ...
        const hints = [
            { rel: 'dns-prefetch', href: import.meta.env.VITE_API_BASE_URL },
