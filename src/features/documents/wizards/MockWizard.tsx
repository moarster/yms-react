...
const MockWizard = () => {
    ...
    const canProceed = () => {
        switch (currentStep) {
            ...
            case 1:
                return formData.route.every(point =>
                    point.address && point._counterParty && point._cargoHandlingType &&
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <div className="text-blue-700">
                            {mockTransportationTypes.find(t => t.id === formData._transportationType)?.name || 'Не выбрано'}
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="text-blue-700">
                            {mockVehicleTypes.find(t => t.id === formData._requiredVehicleType)?.name || 'Не выбрано'}
                        </div>
                    </div>
                </div>
            </div>
