...
export const isDataEntity = (obj: unknown): obj is DataEntity => isBaseEntity(obj) && 'data' in obj;

export const isDomainEntity = (obj: unknown): obj is DomainEntity =>
  isDataEntity(obj) && ('status' in obj || 'process' in obj || 'meta' in obj);

export const isMetadataEntity = (obj: unknown): obj is MetadataEntity =>
  typeof obj === 'object' && obj !== null && 'schema' in obj;
...
export const isPersistedEntity = <T extends BaseEntity>(
  obj: T,
): obj is T & Required<Pick<T, 'createdBy' | 'createdDate' | 'id'>> =>
  hasId(obj) &&
  'createdBy' in obj &&
  'createdDate' in obj &&
...
export const hasRequiredFields = <T extends Record<string, unknown>>(
  obj: unknown,
  fields: (keyof T)[],
): obj is T => typeof obj === 'object' && obj !== null && fields.every((field) => field in obj);
