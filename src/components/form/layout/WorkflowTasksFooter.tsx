...
export const WorkflowTasksFooter: React.FC<WorkflowTasksFooterProps> = ({
    ...
    const getTaskClasses = (variant?: string) => {
        const base = "inline-flex items-center px-4 py-2 border text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50"
